...
| :- | :- | :- | :- | :- | :- |
|1 |merchantKey |String |<p>Min=4 </p><p>Max=200 </p>|Merchant Key of the Merchant<br>Unique identifier for the Merchant [Given by PAYable]<br>**Format: a-zA-Z0-9**|M |
...
|5|notificationUrl |String |<p>Min: 11</p><p>Max: 300 </p>|PAYable Update Transaction API Endpoint URL<br>**Format - Valid HTTPS Web URL** |M |
...
|10|currencyCode|String|Max :3|Currency Code: LKR|M|
|11|orderDescription|String|Max :125|<p>Small Description for the Order</p><p>**Format: a-zA-Z0-9**</p>||
|12|customerFirstName |String |Min=1 Max=50 |<p>Customer’s First Name </p><p>**Format: a-zA-Z0-9**</p>|M |
|13|customerLastName |String |Min=1 Max=50 |<p>Customer’s Last Name </p><p>**Format: a-zA-Z0-9**</p>|M |
...
|16|billingAddressStreet|String|Min=1 Max=100|<p>Billing Details - Billing Address - Street </p><p>**Format: a-zA-Z0-9 and spaces**</p>|M|
...
|25|shippingAddressStreet|String|Max=100|<p>Shipping Details - Shipping Address - Street </p><p>**Format: a-zA-Z0-9 and dash, dot, comma, forward slash, parenthesis, & and spaces**</p>|O|
